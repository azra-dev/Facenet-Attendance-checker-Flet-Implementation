...
def clear(e):
    captured_frame.src = None
    captured_frame.src_base64 = None
    clear_button.disabled = True
    trigger_capture()

# COMPONENTS
capture_button = ft.ElevatedButton("Recognize Face", on_click=trigger_capture)
update_database_button = ft.ElevatedButton("Update Database", on_click=modify_database)
